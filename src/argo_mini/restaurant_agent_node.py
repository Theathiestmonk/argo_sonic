...
from argo_mini.stt import WakeWordDetector, StreamingRecognizer, STTPipeline
    ...
    def say(self, text: str):
        ...
        try:
            ...
            if audio is not None:
                ...
                time.sleep(duration + 1.0)  # +1s echo tail before mic reopens
        except Exception as e:
...
class RestaurantAgentNode(Node):
    ...
    def _build_stt_pipeline(self) -> STTPipeline:
        ...
        wake = WakeWordDetector(
            model_paths=oww_paths if oww_paths else None,
            threshold=0.5,
        )
